...
La evidencia de certificación de un SHA concreto se conserva en la PR y en GitHub Actions, no dentro de este archivo versionado, para no invalidar el propio SHA al documentarlo.
