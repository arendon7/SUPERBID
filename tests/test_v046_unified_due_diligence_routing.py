...
def test_validate_market_routes_to_exact_v044_lot_workflow():
    ...
    assert "superbid-market-review-dashboard/lots/${id}\">Mercado" in ts
...
def test_fast_lane_is_exactly_documentary_market_plus_cost_blockers():
    ...
    assert "menor capas" not in ts.lower()  # guard against accidental semantic drift in source copy
...
def test_v046_keeps_v044_and_v045_authority_boundaries_intact():
